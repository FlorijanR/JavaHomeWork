...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	public void add(T value) {
		...
		if (size == elements.length) {
			T[] elementsTemp = (T[]) new Object[2*elements.length];
	 ...
	 * @version 1.0
	 */
	private static class ElementsGetterArray<U> implements ElementsGetter<U>{
		/**
		 ...
		 * there are more.
		 */
		private ArrayIndexedCollection<U> aic;
		/**
		 * Count the number of modifications
		 * of the list.
		 */
		 ...
		 */
		public ElementsGetterArray(ArrayIndexedCollection<U> aic) {
			currentIndex = 0;
			this.aic = aic;
