...
public class LinkedListIndexedCollection<T> implements List<T>{
	 ...
	 * @version 1.0
	 */
	private static class ElementsGetterList<U> implements ElementsGetter<U>{
		/**
		 * Saves current node in collection 
		 * whose value is next to return.
		 */
		private ListNode<U> currentNode;
		/**
		 ...
		 * there are more.
		 */
		private LinkedListIndexedCollection<U> llc;
		 ...
		 */
		public ElementsGetterList(LinkedListIndexedCollection<U> llc) {
